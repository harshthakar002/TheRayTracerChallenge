...
def test_gradient_pattern():
    ...
    assert pattern.color_at_object_point(s, Point(0.25, 0, 0)) == Color(0.75, 0.75, 0.75)
    assert pattern.color_at_object_point(s, Point(0.5, 0, 0)) == Color(0.5, 0.5, 0.5)
    assert pattern.color_at_object_point(s, Point(0.75, 0, 0)) == Color(0.25, 0.25, 0.25)